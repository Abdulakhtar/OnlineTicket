...
{
    public abstract class OnlineTicketWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static OnlineTicketWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(OnlineTicketWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<OnlineTicketDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<OnlineTicketDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<OnlineTicketDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<OnlineTicketDbContext, Task<T>> func)
        {
            T result;
