...
namespace OnlineTicket.Migrations
{
    ...
    [Migration("20220131064902_newFieldAdded")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineTicket.Students.Student", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("OnlineTicket.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("OnlineTicket.Authorization.Users.User", null)
                        .WithMany("Claims")
