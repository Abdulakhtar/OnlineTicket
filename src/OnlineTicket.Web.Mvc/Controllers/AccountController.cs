...
using OnlineTicket.Sessions;
using OnlineTicket.Web.Models.Account;
using OnlineTicket.Web.Views.Shared.Components.TenantChange;

namespace OnlineTicket.Web.Controllers
{
    public class AccountController : OnlineTicketControllerBase
    {
